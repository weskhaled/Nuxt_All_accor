...
import type { CoreLibrary, MapsLibrary } from 'google.maps'
...
export function useGoogleMaps(mapRef: Ref<HTMLElement | null | undefined>) {
    ...
    loader
      ...
      .then((coreApi) => {
        ...
        loader
          .importLibrary('maps')
          .then((googleMaps) => {
            gMapsInstance.value = new googleMaps.Map(unref(mapRef) as HTMLElement, mapOptions(googleMapsCoreApi.value))
