...
<template>
  <a-layout class="relative h-[calc(100vh-2.25rem)] min-h-screen flex font-sans !flex-row">
    <a-layout-sider
      ...
      :collapsed="true"
      class="hidden border-r-1px border-stone-2 md:block [&_.arco-layout-sider-children]:flex [&_.arco-layout-sider-children]:flex-col [&_.arco-layout-sider-children]:items-center [&_.arco-layout-sider-children]:justify-between dark:border-stone-9"
    >
      <div>
        <div class="mb-3 mt-3 h-10 w-full flex items-center justify-center">
          <a href="" class="relative hidden sm:flex" @click.prevent="async () => await $router.push('/')">
            <span class="flex items-center">
              <svg class="fill-current text-black dark:text-white" aria-hidden="true" focusable="false" width="35" height="25" viewBox="0 0 76 46">
        ...
        <a-menu
          ...
          class="[&_.arco-icon]:h-1.2em [&_.arco-icon]:w-1.2em"
        >
          <a-menu-item key="1">
            <span class="i-carbon-home arco-icon mx-0 inline-block text-sm !h-4.5 !w-4.5" />
            Séjours
          </a-menu-item>
          <a-menu-item key="2">
            <span class="arco-icon i-carbon-search mx-0 inline-block text-sm !h-4.5 !w-4.5" />
            Recherche
          </a-menu-item>
          <a-menu-item key="3">
            <span class="arco-icon i-carbon-calendar-heat-map mx-0 inline-block text-sm !h-4.5 !w-4.5" />
            Activités
          </a-menu-item>
          <a-menu-item key="4">
            <span class="arco-icon i-carbon-chat mx-0 inline-block text-sm !h-4.5 !w-4.5" />
            Réunions & Evenements
          </a-menu-item>
          <a-menu-item key="5">
            <span class="arco-icon i-carbon-plane-private mx-0 inline-block text-sm !h-4.5 !w-4.5" />
            Professionnels
          </a-menu-item>
          <a-sub-menu key="6">
            <template #title>
              <span>
                <span class="arco-icon i-carbon-train-speed mx-0 inline-block text-sm !h-4.5 !w-4.5" />
                Taxis et VTC
              </span>
            </template>
            <a-menu-item key="6_1">
